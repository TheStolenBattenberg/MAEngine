...
global._MAE_ForwardPipelineCreate = external_define(_DLL, "MAE_ForwardPipelineCreate", dll_cdecl, ty_real, 0);
global._MAE_ForwardPipelineDestroy = external_define(_DLL, "MAE_ForwardPipelineDestroy", dll_cdecl, ty_real, 1, ty_real);
global._MAE_ForwardPipelineCreateModel = external_define(_DLL, "MAE_ForwardPipelineCreateModel", dll_cdecl, ty_real, 3, ty_real, ty_real, ty_real);
global._MAE_ForwardPipelineDestroyModel = external_define(_DLL, "MAE_ForwardPipelineDestroyModel", dll_cdecl, ty_real, 1, ty_real);
global._MAE_ForwardPipelineRenderModel = external_define(_DLL, "MAE_ForwardPipelineRenderModel", dll_cdecl, ty_real, 2, ty_real, ty_real);
global._MAE_ForwardPipelineSetMVP = external_define(_DLL, "MAE_ForwardPipelineSetMVP", dll_cdecl, ty_real, 1, ty_real);
global._MAE_ForwardPipelineSetNormal = external_define(_DLL, "MAE_ForwardPipelineSetNormal", dll_cdecl, ty_real, 1, ty_real);
...
global._MAE_ModelDraftLoadMPM = external_define(_DLL, "MAE_ModelDraftLoadMPM", dll_cdecl, ty_real, 1, ty_string);
global._MAE_ModelDraftDestroy = external_define(_DLL, "MAE_ModelDraftDestroy", dll_cdecl, ty_real, 1, ty_real);
...
global._MAE_TextureCollectionCreate = external_define(_DLL, "MAE_TextureCollectionCreate", dll_cdecl, ty_real, 0);
global._MAE_TextureCollectionDestroy = external_define(_DLL, "MAE_TextureCollectionDestroy", dll_cdecl, ty_real, 1, ty_real);
global._MAE_TextureCollectionAdd = external_define(_DLL, "MAE_TextureCollectionAdd", dll_cdecl, ty_real, 3, ty_real, ty_string, ty_real);
