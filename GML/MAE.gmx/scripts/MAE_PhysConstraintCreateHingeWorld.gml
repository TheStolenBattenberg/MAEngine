///MAE_PhysConstraintCreateHingeWorld(body,transform,use_reference_frameA,disable_collision);
...
return external_call(global._MAB_ConstraintCreateHinge, argument0, 0, argument2, argument3);
