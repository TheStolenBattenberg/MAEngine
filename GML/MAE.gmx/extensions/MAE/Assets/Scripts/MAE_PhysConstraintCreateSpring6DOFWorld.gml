///MAE_PhysConstraintCreateSpring6DOFWorld(body,transform,use_reference_frameA,disable_collision);
...
return external_call(global._MAB_ConstraintCreateSpring6DOF, argument0, 0, argument2, argument3);
