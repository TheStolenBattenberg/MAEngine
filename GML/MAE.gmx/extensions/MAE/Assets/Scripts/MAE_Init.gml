...
global._MAE_TextureCreate = external_define(_DLL, "MAE_TextureCreate", dll_cdecl, ty_real, 0);
global._MADX9_TextureCreateFromFile = external_define(_DLL, "MADX9_TextureCreateFromFile", dll_cdecl, ty_real, 3, ty_real, ty_string, ty_real);
global._MADX9_TextureCreateFromFileInMemory = external_define(_DLL, "MADX9_TextureCreateFromFileInMemory", dll_cdecl, ty_real, 4, ty_real, ty_string, ty_real, ty_real);
...
global._MAE_ShaderCompileD3D9HLSL9 = external_define(_DLL, "MAE_ShaderCompileD3D9HLSL9", dll_cdecl, ty_real, 3, ty_real, ty_string, ty_string);
global._MAE_ShaderCompileD3D9ASM = external_define(_DLL, "MAE_ShaderCompileD3D9ASM", dll_cdecl, ty_real, 3, ty_real, ty_string, ty_string);
global._MAE_ShaderCreate = external_define(_DLL, "MAE_ShaderCreate", dll_cdecl, ty_real, 0);
