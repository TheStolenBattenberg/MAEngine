...
///MAE_PhysConstraintCreateHinge(bodyA, transformA, use_reference_frameA, disable_collision)
/*
Creates a hinge constraint. The second body is optional, and if left out the constraint will attach to the world instead.
...
if(argument_count == 4) return external_call(global.MAB_ConstraintCreateHinge, argument[0], 0, argument[2], argument[3]);
...
return external_call(global.MAB_ConstraintCreateHinge, argument[0], argument[2], argument[4], argument[5]);
